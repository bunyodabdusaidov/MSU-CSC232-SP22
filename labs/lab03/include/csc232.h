...
#define STARTED_TASK1 TRUE
#define STARTED_TASK2 TRUE
#define STARTED_TASK3 TRUE

#define COMPLETED_TASK1 TRUE
#define COMPLETED_TASK2 TRUE
#define COMPLETED_TASK3 TRUE
#include <algorithm>
#include <cassert>
#include <climits>
#include <cmath>
